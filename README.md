...
GET    /admin/occupancy              - Occupancy rates
GET    /admin/trends/booking         - Booking trends
GET    /admin/performance/rooms      - Room performance
GET    /admin/analytics/reviews      - Review analytics
GET    /admin/demographics/users     - User demographics
```
