                ...
                >
                    <SwiperSlide>
                        <div
                            ...
                            style={{
                                backgroundImage:
                                    "url(../src/assets/images/luxury_stay_homeslide.jpg)",
                            }}
                        >
                    ...
                    <SwiperSlide>
                        <div
                            ...
                            style={{
                                backgroundImage:
                                    "url(../src/assets/images/comfort_elegance_homeslide.jpg)",
                            }}
                        >
                            <h1 className="text-white text-5xl font-bold bg-black/50 px-6 py-4 rounded-xl">
                                Comfort & Elegance
                    ...
                    <SwiperSlide>
                        <div
                            ...
                            style={{
                                backgroundImage:
                                    "url(../src/assets/images/book_dream_room_homeslide.jpg)",
                            }}
                        >
                            <h1 className="text-white text-5xl font-bold bg-black/50 px-6 py-4 rounded-xl">
