...
import mockRooms from "../api/mockRooms";
  ...
  const fetchRooms = async () => {
    try {
      ...
      if (filters.checkIn && filters.checkOut) {
        ...
        setRooms([...availableRooms, ...mockRooms]);
      }
      ...
      console.log("API failed, using mock rooms");
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    <b>Try:</b> "deluxe", "suite", "garden", "city loft", "ocean
                    view", "mountain cabin" etc.
                  </p>
                </div>
                    ...
                    {["wifi", "ac", "tv", "coffee"].map((amenity) => (
                      <label key={amenity} className="flex items-center">
                        <input
                          ...
                          onChange={(e) => {
                            let amenities = filters.amenities
                              .split(",")
                              .filter((a) => a);
                            if (e.target.checked) {
                  ...
                  >
                    ...
                    <div className="h-48 bg-gray-200 overflow-hidden">
                      <img
                        src={
                          room.images?.[0] ||
                          "https://mern-hotel-booking-system.netlify.app/images/no_image.jpg"
                        }
                        alt={room.name}
