...
const AdminDashboard = () => {
    ...
    const handleRoomSubmit = async (e) => {
        ...
        try {
            // Validate images
            const filteredImages = roomForm.images.filter(img => img !== "");
            if (filteredImages.length === 0) {
                alert("Please upload at least one image for the room");
            ...
            if (errorMessage.includes("413") || errorMessage.includes("payload")) {
                alert("Images are too large. Please use smaller image files (max 5MB each)");
